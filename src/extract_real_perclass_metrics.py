...
def extract_real_metrics():
    ...
    for model_name in models:
        ...
        try:
            ...
            # Note: YOLO validation does not provide per-class precision/recall
            # Only overall metrics and per-class AP@0.5 are available
            # Removed estimated calculations to maintain accuracy
